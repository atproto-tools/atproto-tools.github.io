...
- Basically, we attempt to process and present links collected from [various awesome-atproto lists](https://atproto-tools.getgrist.com/p2SiVPSGqbi8/main-list/p/7) around the web.
  id:: 677672f7-5e29-4db1-a373-b6d3fed4549a
	...
	- [db schema]([[schema]])
		...
		- The crawler scripts and the submission form are run from [windmill](https://github.com/windmill-labs/windmill). If you would like to contribute, dm me on bsky omniraptor.bsky.social]
- relevant docs
